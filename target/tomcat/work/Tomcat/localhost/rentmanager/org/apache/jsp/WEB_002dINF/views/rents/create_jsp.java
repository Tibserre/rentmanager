 ...
 * Generated at: 2022-03-11 11:57:47 UTC
...
public final class create_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("                                <button type=\"submit\" class=\"btn btn-info pull-right\" id=\"ButtonAjouter\" >Ajouter</button>\n");
      out.write("                            </div>\n");
      ...
      out.write("    });\n");
      out.write("\n");
      out.write("    $('#begin').on('change',()=>{\n");
      out.write("        if ($('#end').val()){\n");
      out.write("            var date1 = new Date($('#end').val());\n");
      out.write("            var date2 = new Date($('#begin').val());\n");
      out.write("            var diffTime = Math.abs(date2 - date1);\n");
      out.write("            var diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));\n");
      out.write("            if(diffDays>7){\n");
      ...
      out.write("        }\n");
      out.write("    });\n");
      out.write("    $('#end').on('change',()=>{\n");
      out.write("        if ($('#begin').val()){\n");
      out.write("            var date1 = new Date($('#end').val());\n");
      out.write("            var date2 = new Date($('#begin').val());\n");
      out.write("            var diffTime = Math.abs(date2 - date1);\n");
      out.write("            var diffDays = Math.ceil(diffTime / (1000 * 60 * 60 * 24));\n");
